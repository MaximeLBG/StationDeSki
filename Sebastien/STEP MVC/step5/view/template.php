...
<body>
    ...
    <a class="nav-link px-3" href="#">Espace de connexion</a>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    ...
                    <li class="nav-item">
                        ...
                        <span data-feather="Températures mesurées"></span>
    ...
    <!-- C'esy ici que vient se greffer le contenu généré par la vue associée -->
    <?= $content ?>
    </main>
</div>    
